...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in FileExchange/fileexchange_pb2_grpc.py depends on'
...
class FileExchangeStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Upload = channel.stream_unary(
                '/Dressy.FileExchange.FileExchange/Upload',
...
def add_FileExchangeServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'Dressy.FileExchange.FileExchange', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('Dressy.FileExchange.FileExchange', rpc_method_handlers)
